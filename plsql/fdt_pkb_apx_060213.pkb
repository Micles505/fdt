create or replace package body fdt_pkb_apx_060213 is
   --
...
--   cva_delete_row_status constant varchar2(3) := 'D';
   --
   cva_nom_collection    constant varchar2(30) := 'COL_060213';
   --
   ...
   procedure p_valider_coherence (pnu_no_seq_direction     in number,
      ...
      cursor cur_ass_typ_serv_qualf is
         ...
         select apex_et_bd.no_seq_ass_typ_serv_qualf,
                ...
                typ_serv.description             typ_service_desc,
         ...
         from   apex_et_bd                          apex_et_bd 
                left join fdtt_typ_service     typ_serv   on typ_serv.no_seq_typ_service = apex_et_bd.no_seq_typ_service
                left join fdtt_qualification        qualf      on qualf.no_seq_qualification  = apex_et_bd.no_seq_qualification
	     where  apex_et_bd.no_seq_typ_service    = pnu_no_seq_typ_service
		 and    apex_et_bd.no_seq_qualification  = pnu_no_seq_qualification
	     union
		 select ass.no_seq_ass_typ_serv_qualf,
		        ass.no_seq_typ_service,
                typ_serv.description             typ_service_desc,
         ...
         from   fdtt_ass_typ_serv_qualf             ass
                left join fdtt_typ_service          typ_serv  on typ_serv.no_seq_typ_service   = ass.no_seq_typ_service
				                                                 and typ_serv.no_seq_direction = pnu_no_seq_direction
	     ...
	     where  ass.no_seq_typ_service        = pnu_no_seq_typ_service
		 and    ass.no_seq_qualification      = pnu_no_seq_qualification
		 and    ass.no_seq_ass_typ_serv_qualf not in (select apex_et_bd.no_seq_ass_typ_serv_qualf
				                                      from   apex_et_bd);
      --
      --
	  ...
	  -- selon le type service / qualification
	  --
   ...
   begin
      ...
      if not apex_collection.collection_exists(cva_nom_collection) Then
	     ...
	     --
         -- Récupération des données de la table fdtt_ass_typ_serv_qualf
		 --
         ...
         --
		 if vta_rec_ass_typ_serv_qualf.count > 1 Then
