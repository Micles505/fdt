$.widget('pretius.enhancedLovItem', {
  ...
  _getOnLoadLov: function (pValue) {
    ...
    var
      ...
      pageItems = this.options.item.lov_cascade_parent_items == null ||
        this.options.item.lov_cascade_parent_items == undefined ? '' :
        '#' + this.options.item.lov_cascade_parent_items;
    ajaxData = {
      "x01": mode,  //tryb
      "f01": values, //selected values
      "pageItems": pageItems // Cascading lov items
    };
    ajaxOptions = {
  ...
  */
  ...
  _popupAjaxGetOnlySelected: function () {
    ...
    var pageItems = this.options.item.lov_cascade_parent_items == null ||
      this.options.item.lov_cascade_parent_items == undefined ? '' :
      '#' + this.options.item.lov_cascade_parent_items,
      ajaxData = {
  ...
  _popupCreateNew: function () {
    ...
    var
      ...
      buttonSelect = $('<button class="t-Button t-Button--icon t-Button--iconLeft t-Button--hot select"><span class="t-Icon t-Icon--left fa fa-check"></span><span class="t-Button-label">' + this.C_POPUP_BTN_SELECT_TEXT + '</span></button>'),
  ...
  */
  ...
  _promptUnselectValue: function (pValue, pLi) {
    ...
    this._maskStateSelectedRemove(indexOf, change);
  ...
  _promptApplyValues: function (pTriggerChange) {
    ...
    if (pTriggerChange) {
      apex.debug.log(this.logPrefix, '_promptApplyValues', 'trigger Change',this);
