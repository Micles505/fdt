create or replace package fdt_pkb_apx_010107 is
  -- ====================================================================================================
  -- Date        : 2022-05-10
  -- Par         : SHQYMR
  ...
  function f_obtenir_items_lov_intervention(pnu_no_seq_ressource         in fdtt_ressource.no_seq_ressource%type,
    ...
    pipelined;
  -- ---------------------------------------------------------
  -- Sélectionner le no_seq_feuil_temps d'une ressource
  -- selon AN_MOIS_FDT
  -- ---------------------------------------------------------
  function f_obt_seq_feuil_temps (pnu_no_seq_ressource in fdtt_ressource.no_seq_ressource%type,
                                  pva_an_mois_fdt      in fdtt_temps_intervention.an_mois_fdt%type) return number;
  -- ---------------------------------------------------------
